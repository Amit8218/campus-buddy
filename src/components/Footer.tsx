    ...
    <footer className={cn("bg-background border-t", className)}>
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <h3 className="text-lg font-semibold">Campus Buddy</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Your AI assistant for all campus-related information.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-2">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Campus Map</a>
                </li>
              </ul>
            </div>
          </div>
